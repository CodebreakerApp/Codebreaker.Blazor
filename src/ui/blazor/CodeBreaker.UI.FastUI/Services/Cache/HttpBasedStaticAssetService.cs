...
public class CodeBreakerHttpBasedStaticAssetService : IStaticAssetService
{
    private readonly HttpClient _httpClient;
    private readonly CodeBreakerCacheStorageAccessor _cacheStorageAccessor;

    public CodeBreakerHttpBasedStaticAssetService(HttpClient httpClient, NavigationManager navigationManager, CodeBreakerCacheStorageAccessor cacheStorageAccessor)
    {
